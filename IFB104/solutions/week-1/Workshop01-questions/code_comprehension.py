...
# prediction that the code print(a-b) outputs:
# >>> 56
# Assessment after run: correct
...
# prediction that the variable x_squared_plus_y_times_2 outputs:
# >>> 60
# Assessment after run: resultant output was 60.0 (type float), I incorrectly predicted an int object type output